...
class ItunesDataDisplayManagerImplementation: NSObject, ItunesDataDisplayManager {

    var viewModels: [SearchResultViewModel] = []
    var factory: ItunesCellViewModelFactory!
    ...
    func update(_ itunesItems: [ITunesItem], cellDelegate: SearchResultCellDelegate) {
        viewModels = factory.viewModels(from: itunesItems,
